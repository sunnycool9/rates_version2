...
#oc import-image ratesinfo-project/ratesinfo1:main1 --from="docker.io/sunnycool17/rates1:v2" --confirm
oc tag docker.io/sunnycool17/rates1:v2 ratesinfo-project/ratesinfo1:main1

#oc new-app --name=ratesinfo1 sunnycool17/rates1:v2 -n ratesinfo-project
